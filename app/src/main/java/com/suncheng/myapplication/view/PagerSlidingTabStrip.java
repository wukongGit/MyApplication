...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorPading = 12;
	private int dividerWidth = 1;

	private int tabTextSize = 16;
	private int tabTextColor = 0xFF3C415F;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		indicatorPading = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, indicatorPading, dm);
		...
		indicatorPading = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorPaddingLeftRight, indicatorPading);
